...
function exitHyperMode()
	...
	if This.sendEscape then
		...
		This.sendEscape = false
	end
	This.escapeTimer:stop()
end
...
function This.install(hotKey, escape_delay)
	This.sendEscape = false
	-- If `control` is held for this long, don't send `escape`
	This.escapeTimer = hs.timer.delayed.new(escape_delay, function()
		This.sendEscape = false
	end)
